            ...
            <div class="d-sm-flex">
              <div class="media">
                ...
                <div class="media-body">
                  ...
                  <h4 class="tx-20 tx-sm-18 tx-md-20 tx-normal tx-rubik mg-b-0">{{ $cseServiceRequests->where('service_request_status_id', '>', '3')->count() }}</h4>
                </div>
              </div>
              ...
              <tbody>
                @foreach ($cseServiceRequests as $serviceRequest)
                  <tr>
                    ...
                    <td class="tx-medium">{{ $serviceRequest->technician->user->fullName->name }}</td>
                    ...
                    <td class=" text-center">
                      <div class="dropdown-file">
                        ...
                        <a href="{{ route('cse.request_details', $serviceRequest->id) }}" class="dropdown-item details"><i class="far fa-clipboard"></i> Details</a>
                        </div>
                      </div>
                    </td>
                  </tr>
