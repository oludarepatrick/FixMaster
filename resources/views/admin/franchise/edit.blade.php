    ...
    <div class="container pd-x-0">
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Edit Demo Franchise</h4>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="form-row">
              <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="first_name" placeholder="Name" value="Demo Franchise">
              </div>
              <div class="form-group col-md-4">
                  <label for="middle_name">CAC Number</label>
                  <input type="tel" class="form-control" id="middle_name" placeholder="CAC Number" value="2347923074732">
              </div>
              <div class="form-group col-md-4">
                  <label for="last_name">Date Established</label>
                  <input type="date" class="form-control" id="last_name" placeholder="Date Established" value="11-20-1999">
              </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-4">
              <label for="inputEmail4">Email</label>
              <input type="email" class="form-control" id="inputEmail4" placeholder="Email" value="info@demofranchise.com">
            </div>
            <div class="form-group col-md-4">
              <label for="phone_number">Phone Number</label>
              <input type="tel" class="form-control" id="phone_number" placeholder="Phone Number" value="090632789233">
            </div>
            <div class="form-group col-md-4">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <textarea rows="3" class="form-control" id="inputAddress2">7, Abagbo Close, Victoria Island, Lagos, Nigeria</textarea>
              </div>
          </div>
