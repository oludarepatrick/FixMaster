      ...
      <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
          <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('cse.requests_completed') }}">Completed Requests</a></li>
        ...
        <div class="col-lg-12 col-xl-12">
          <div class="card">
            <ul class="nav nav-tabs nav-justified" id="myTab3" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" id="update-tab3" data-toggle="tab" href="#update3" role="tab" aria-controls="update" aria-selected="true">Client Job Rating</a>
                </li>
                <li class="nav-item">
              ...
              <div class="tab-content bd bd-gray-300 bd-t-0 pd-20" id="myTabContent3">
                ...
                <div class="tab-pane fade" id="rfq3" role="tabpanel" aria-labelledby="rfq-tab3">
                  ...
                  <h6 class="mt-4">Tools Request</h6>
                  <div class="table-responsive">
                    <table class="table table-hover mg-b-0">
                      <thead class="">
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-medium">Admin-32423</td>
                          <td class="text-medium tx-center">May 15th 2020 at 11:30am</td>
                        </tr>
                  ...
                  <h6 class="mt-4">Request For Quotation <span class="text-success">(Accepted)</span></h6>
                  <div class="table-responsive">
                    <table class="table table-hover mg-b-0">
                      <thead class="">
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-medium">Golden Tribe LTD</td>
