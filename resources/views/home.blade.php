                            ...
                            >
                                <table class="col-600" width="600" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="center" style="color: #fff; font-weight: bold; font-size: 25px; line-height: 24px;">When FixMaster repairs - you Relax!!!</td>
                                        </tr>
                                        <tr>
                                            <td height="10"></td>
                                        </tr>
            ...
            <td align="center">
                <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left: 20px; margin-right: 20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                    <tbody>
                        ...
                        <tr>
                            <td align="center" style="font-size: 22px; font-weight: bold; color: #2a3a4b;">Welcome to FixMaster!</td>
                        </tr>
                        <tr>
                            <td height="10"></td>
                        </tr>
                        <tr>
                            <td align="center" style="font-size: 14px; color: #757575; line-height: 24px; font-weight: 300;">
                                Hello, <strong>'.$clientName.'</strong>, We are very excited to have you on FixMaster. Activate your account to book your first job and have the full experience.
                            </td>
                        </tr>
                    </tbody>
                </table>
                        ...
                        <tr>
                            <td>
                                <table width="1" height="20" border="0" cellpadding="0" cellspacing="0" align="left">
                                    <tbody>
                                        <tr>
                                            <td height="20" style="font-size: 0; line-height: 0; border-collapse: collapse;"><p style="padding-left: 24px;">&nbsp;</p></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" class="col-600" width="600" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                <tr>
                                                    <td align="center" bgcolor="#E97D1F">
                                                                        ...
                                                                        <table class="col3_one" width="380" border="0" align="right" cellpadding="0" cellspacing="0">
                                                                            <tbody>
                                                                                <tr align="left" valign="top">
                                                                                    <td style="font-size: 20px; color: #fff; line-height: 30px; font-weight: bold;">Verify E-Mail!</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="5"></td>
                                                                                </tr>
                                                                                <tr align="left" valign="top">
                                                                                    <td style="font-size: 14px; color: #fff; line-height: 24px; font-weight: 300;">To verify your email, simply click the "Verify E-Mail" button.</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="10"></td>
                                                                                </tr>
                                                                                <tr align="left" valign="top">
                                                                                    <td>
                                                                                        <table class="button" style="border: 2px solid #fff;" bgcolor="#E97D1F" width="30%" border="0" cellpadding="0" cellspacing="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td width="10"></td>
                                                                                                    <td height="30" align="center" style="font-size: 13px; color: #ffffff;">
                                                                                                        <a href="http://temp.homefix.ng/client-email-verify?token='.$token.'" style="color: #ffffff;">Verify E-Mail</a>
                                                                                                    </td>
                                                                                                    <td width="10"></td>
                                                                                                </tr>
                                                                                            </tbody>
                                ...
                                <tr>
                                    <td>
                                        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left: 40px; margin-right: 20px; margin-top: 20px;">
                                            <tbody>
                                                <tr>
                                                    <td>Thanks,</td>
                                                </tr>
                                                <tr>
                                                    <td>FixMaster Management</td>
                                                </tr>
                                                <tr>
                                                    <td><img class="CToWUd" src="http://temp.homefix.ng/assets/images/home-fix-logo-colored.png" alt="FixMaster Logo" width="70" /></td>
                                                </tr>
                                                <td>284B, Ajose Adeogun Street, Victoria Island, Lagos, Nigeria. 08132863878|<a href="mailto:info@fixmaster.com.ng" target="_blank" rel="noopener">info@fixmaster.com.ng</a></td>
                                                <td>&nbsp;</td>
                                                <tr>
                                                    <td><hr /></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        If you&rsquo;re having trouble clicking the "Verify E-Mail" button, copy and paste the URL below into your web browser:
                                                        <a href="http://temp.homefix.ng/client-email-verify?token='.$token.'" target="_blank">http://temp.homefix.ng/client-email-verify?token='.$token.'</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <table class="insider" width="237" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                            <tbody>
                                                                                                <tr align="left">
                                                                                                    <td style="font-size: 23px; color: #2a3b4c; line-height: 30px; font-weight: bold;">What we do?</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="5"></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="font-size: 14px; color: #7f8c8d; line-height: 24px; font-weight: 300;">
                                                                                                        FixMaster is Nigeria’s Topmost maintenance service provider. We install service and repair all household and office appliances. We also
                                                                                                        provide maintenance and service facilities for all plumbing, electrical, security, interior decorations, carpentry, cleaning, and
                                                                                                        gardening services.
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                    ...
                                                                    <td align="center" bgcolor="#34495e" background="https://designmodo.com/demo/emailtemplate/images/footer.jpg" height="185">
                                                                        <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" style="font-size: 26px !important; font-weight: bold !important; color: #fff !important;">Follow us on social media</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="25"></td>
                                                                                </tr>
