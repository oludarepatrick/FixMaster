...
Route::middleware(['clientRole'])->group(function() {
    Route::prefix('client')->group(function () {
        ...
        Route::get('/messages', 	            [App\Http\ClientMessagingController::class, 'index'])->name('client.messages');
        Route::post('messages',                  [App\Http\ClientMessagingController::class, 'sendMessage'])->name('client.send_message');
